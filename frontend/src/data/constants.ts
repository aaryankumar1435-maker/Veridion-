...
export const LEADERSHIP_DATA: Record<string, LeadershipMember> = {
  elizabeth: {
    name: 'Atharva Manocha',
    role: 'CEO & Co-Founder',
    icon: 'User',
    bio: 'Atharva leads our overall design vision, product operations, and strategic roadmaps. Under his oversight, Veridion has prioritized light architectures that process enterprise updates instantaneously.',
    instagram: 'https://instagram.com/konmanocha',
    instagram_handle: '@konmanocha',
    twitter: 'https://twitter.com/AtharvaManocha',
    twitter_handle: '@AtharvaManocha',
    linkedin: 'https://linkedin.com/company/AtharvaManocha',
    linkedin_handle: 'AtharvaManocha',
    email: 'manochaatharva@gmail.com',
  },
  marcus: {
    name: 'Sayman Lal',
    role: 'Lead System Architect',
    icon: 'User',
    bio: 'Sayman commands full system telemetry. He specializes in designing lightweight, distributed REST architectures, optimizing query response rates, and orchestrating native blockchain configurations.',
    instagram: 'https://instagram.com/saymanlal',
    instagram_handle: '@saymanlal',
    twitter: 'https://twitter.com/saymanlal',
    twitter_handle: '@saymanlal',
    linkedin: 'https://linkedin.com/company/saymanlal',
    linkedin_handle: 'saymanlal',
  ...
  aria: {
    ...
    icon: 'User',
    bio: 'Aryan safeguards the transmission integrity of our platform. She focuses on engineering cryptographically secure endpoints, OAuth pipeline structures, and client identity verification logic.',
    instagram: 'https://instagram.com/aryan_kumar_562',
    instagram_handle: '@aryan_kumar_562',
    twitter: 'https://twitter.com/AaryanKuma21202',
    twitter_handle: '@AaryanKuma21202',
    linkedin: 'https://linkedin.com/company/veridion-mvp',
    linkedin_handle: 'aria-tanaka-nexus',
    email: 'veridionaryan@veridion.co.in',
  },
};
